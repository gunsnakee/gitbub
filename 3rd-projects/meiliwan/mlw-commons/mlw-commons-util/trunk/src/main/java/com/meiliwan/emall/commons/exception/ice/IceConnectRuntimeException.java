package com.meiliwan.emall.commons.exception.ice;
 ...
 * 
 */
public class IceConnectRuntimeException extends  BaseRuntimeException{
	
	private static final long serialVersionUID = 8458544317507845657L;
	
	public IceConnectRuntimeException(String code, String msg, Throwable cause) {
