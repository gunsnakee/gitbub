...
public class QueryStringUtil {
	 ...
	 * @return
	 */
	public static boolean isNumericStartZero(String str) {
		Pattern pattern = Pattern.compile("0[0-9]{1,20}");
	 ...
	 * @return
	 */
	public static boolean isIntegerGreaterThanZero(String in) {
		Pattern pattern = Pattern.compile("[1-9][0-9]{1,11}");
		Matcher isNum = pattern.matcher(in);
		if (!isNum.matches()) {
			return false;
		}
		if(!lessEqualMaxInteger(in)){
			return false;
		}
		return true;
	}

	private static boolean lessEqualMaxInteger(String in) {
		BigInteger max = new BigInteger(Integer.MAX_VALUE+""); //小于－1 等于0 大于1
		if(max.compareTo(new BigInteger(in))<0){
			return false;
		}
		return true;
	}
	...
	public static void main(String[] args) {
		boolean b=false;
		b = QueryStringUtil.isIntegerGreaterThanZero(Integer.MAX_VALUE+"");
		System.out.println(b);
		b = QueryStringUtil.isIntegerGreaterThanZero("1234567890");
		System.out.println(b);

		System.out.println("=====================");
		
		b = QueryStringUtil.isIntegerGreaterThanZero(Integer.MAX_VALUE+"11");
		System.out.println(b);
		b = QueryStringUtil.isIntegerGreaterThanZero("");
		System.out.println(b);
		b = QueryStringUtil.isIntegerGreaterThanZero("0");
		System.out.println(b);
		
		b= isNumericStartZero("01111111111111");
		System.out.println(b);
