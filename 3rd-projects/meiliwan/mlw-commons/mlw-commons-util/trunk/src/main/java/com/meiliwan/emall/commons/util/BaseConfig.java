...
//		System.out.println(BaseConfig.class.getResource(File.separator));
//		System.out.println(BaseConfig.class.getClassLoader().getResource(CONFIGS_WHERE + "/" + FileName.commons));
		...
		for(FileName fileName : values){
			...
			try {
				...
				LOG.error(new BaseException(fileName+".properties file parsed error. msg("+e.getMessage()+")", e), fileName+".properties", "");
			}
		}
	}
