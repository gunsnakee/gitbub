...
//	private final static Logger log = LoggerFactory.getLogger(SearchComponentHttpClient.class);
	...
	SearchComponentHttpClient(String clientName){
		...
		this.clientZkPath = GlobalNames.SEARCH_CHROOT  + "/" + clientName;
		this.clientAliveZkPath = GlobalNames.SEARCH_CHROOT  + "/" + clientName + "_alive";
		openClient();
	}
...
//		ZKClient.get().watchChildren(clientAliveZkPath, new ChildrenWatcher() {
//
