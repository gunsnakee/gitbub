...
public interface IDao<T extends Serializable, M extends BaseEntity> {
    ...
    M getEntityById(T pk, boolean isMainDS);
    ...
    List<M> getEntityByIds(List<T> pks, boolean isMainDS);
    ...
    Map<T, M> getEntityByIds(List<T> pks, String idField, boolean isMainDS);
    /**
     * 通过传入 实体参数 获取对象
     *
     * @param entity
    ...
    M getEntityByObj(M entity, boolean isMainDS);

    M getEntityByIdUseDB(T pk);
    M getEntityByIdUseDB(T pk, boolean isMainDS);
    /**
     * 通过传入 实体参数 获取对象
     *
     * @param entity
    ...
    M getEntityByObj(M entity, String whereSql,boolean isMainDS);
    ...
    int getCountByObj(M entity,boolean isMainDS);
    ...
    int getCountByObj(M entity, String whereSql,boolean isMainDS);
    /**
    ...
    PagerControl<M> getPagerByObj(M entity, PageInfo pageInfo, String whereSql,boolean isMainDS);
    /**
     * 通过实体参数获取对应的实体列表包含物理分页
     *
     * @param entity     实体对象
    ...
    PagerControl<M> getPagerByObj(M entity, PageInfo pageInfo, String whereSql, String orderBySql,boolean isMainDS);
    /**
     * 作用读取所有对象<br/>
    ...
    List<M> getAllEntityObj(boolean isMainDS);
    /**
     * 作用读取对象列表 带实体条件 <br/>
     *
     * @param entity 参数查询
    ...
    List<M> getListByObj(M entity,boolean isMainDS);
    /**
     * 作用读取对象列表 带实体条件 <br/>
     *
     * @param entity   参数查询
    ...
    List<M> getListByObj(M entity, String whereSql,boolean isMainDS);
    /**
     * 作用读取对象列表 带实体条件 <br/>
     *
     * @param entity     参数查询
    ...
    List<M> getListByObj(M entity, String whereSql, String orderBySql,boolean isMainDS);
    /**
     * 作用读取对象列表 带实体条件 <br/>
     *
     * @param entity   参数查询
    ...
    List<M> getListByObj(M entity, PageInfo pageInfo, String whereSql,boolean isMainDS);
    /**
     * 作用读取对象列表 带实体条件 <br/>
     *
     * @param entity     参数查询
    ...
    List<M> getListByObj(M entity, PageInfo pageInfo, String whereSql, String orderBySql,boolean isMainDS);
    /**
     *
     * @param entity     查询参数
     * @param pageInfo   分页对象
    ...
    List<M> getListByObjSortByMultiField(M entity,PageInfo pageInfo,String whereSql,String orderBySql,boolean isMainDS);
