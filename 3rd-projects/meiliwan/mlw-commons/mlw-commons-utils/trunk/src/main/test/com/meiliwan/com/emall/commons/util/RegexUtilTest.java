...
public class RegexUtilTest {
	...
	public void testCheck(){
		...
		result = RegexUtil.isEmail("shang.feng.liu@opi-corp.com");
		System.out.println("isEmail:"+result);
		...
		System.out.println("isEnglishOrDigital:" + RegexUtil.isEnglishOrDigital("Asd34Wou239"));
