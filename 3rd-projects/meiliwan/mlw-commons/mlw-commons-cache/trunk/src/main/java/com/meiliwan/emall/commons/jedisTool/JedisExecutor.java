...
public class JedisExecutor {
	...
	public RedisReturn<Boolean> hexists(JedisKey key, Serializable id,
	 ...
	 * @throws JedisClientException
	 */
	public RedisReturn<Long> expire(JedisKey key, Serializable id, int seconds)
			throws JedisConnectionException, JedisClientException {
	 ...
	 * @throws JedisClientException
	 */
	public RedisReturn<Long> append(JedisKey key, Serializable id, Object value)
			throws JedisConnectionException, JedisClientException {
	 ...
	 * @throws JedisClientException
	 */
	public RedisReturn<String> set(JedisKey key, Serializable id, Object value)
			throws JedisConnectionException, JedisClientException {
	...
	public RedisReturn<String> getSet(JedisKey key, Serializable id,
	 ...
	 * @throws JedisClientException
	 */
	public RedisReturn<Long> hset(JedisKey key, Serializable id, String field,
	...
	public RedisReturn<String> hget(JedisKey key, Serializable id, String field)
			throws JedisClientException {
		return extExec(key, id, new ExtOper<String>(ExtOperType.QUERY) {
			@Override
			String exec(Jedis jedis, String keystr, Object middleKey,
	...
	public RedisReturn<Map<String, String>> hgetAll(JedisKey key,
	...
	public RedisReturn<Long> hdel(JedisKey key, Serializable id,
	...
	public RedisReturn<List<String>> hmget(JedisKey key, Serializable id,
			String... fields) throws JedisConnectionException,
			JedisClientException {
	...
	public RedisReturn<Set<String>> smembers(JedisKey key, Serializable id)
			throws JedisConnectionException, JedisClientException {
	...
	public RedisReturn<Boolean> sismember(JedisKey key, Serializable id,
	...
	public RedisReturn<Long> scard(JedisKey key, Serializable id)
			throws JedisConnectionException, JedisClientException {
	...
	public RedisReturn<String> srandmember(JedisKey key, Serializable id)
			throws JedisConnectionException, JedisClientException {
		return extExec(key, id, new ExtOper<String>(ExtOperType.QUERY) {
			@Override
			String exec(Jedis jedis, String keystr, Object middleKey,
	...
	public RedisReturn<Long> zadd(JedisKey key, Serializable id, double score,
			Object value) throws JedisConnectionException, JedisClientException {
		return extExec(key, id, new ExtOper<Long>(ExtOperType.CHANGE) {
			@Override
			Long exec(Jedis jedis, String keystr, Object score,
	...
	public RedisReturn<Long> decrBy(JedisKey key, Serializable id, int byvalue)
			throws JedisConnectionException, JedisClientException {
		return extExec(key, id, new ExtOper<Long>(ExtOperType.CHANGE) {
			@Override
	...
	public RedisReturn<Long> incrBy(JedisKey key, Serializable id, int byvalue)
			throws JedisConnectionException, JedisClientException {
		return extExec(key, id, new ExtOper<Long>(ExtOperType.CHANGE) {
			@Override
			Long exec(Jedis jedis, String keystr, Object byvalue,
	...
	private <T> T execByPool(JedisPool pool, JedisKey key, Serializable id,
		...
		for (; index < JedisCommon.RETRY_TIMES; index++) {
			try {
				LOGGER.debug("extExec param(host:"
						+ pool.getHost()
						+ ",port:"
						+ pool.getPort()
						+ ",jedisKey:"
