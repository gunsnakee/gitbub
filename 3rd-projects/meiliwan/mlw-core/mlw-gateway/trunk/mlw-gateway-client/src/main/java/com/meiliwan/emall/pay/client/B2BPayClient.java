...
public class B2BPayClient {
	
	private final static MLWLogger LOG = MLWLoggerFactory.getLogger(B2BPayClient.class); 

	public static final String GETPAYID = "b2BPayService/getPayId";

	
	public static boolean log(PayHead payHead) {
		JsonObject obj = IceClientTool.sendMsg(IceClientTool.PAY_ICE_SERVICE,
				JSONTool.buildParams("b2BPayService/log", payHead));
	...
	public static PaymentDTO innerPay(PaymentDTO payment, String password,
			String clientIP) {
		JsonObject obj = IceClientTool.sendMsg(IceClientTool.PAY_ICE_SERVICE,
				JSONTool.buildParams("b2BPayService/innerPay", payment, password,
						 clientIP));
	...
	public static PayHead getPayHead(String orderId, boolean includeItems,
		...
		JsonObject obj = IceClientTool.sendMsg(IceClientTool.PAY_ICE_SERVICE,
				JSONTool.buildParams("b2BPayService/getPayHead", orderId,
	...
	public static void delPayInfoByPayId(String payId) {
		IceClientTool.sendMsg(IceClientTool.PAY_ICE_SERVICE,
				JSONTool.buildParams("b2BPayService/delPayInfoByPayId", payId));
	}
	...
	public static boolean backMoney(String orderId) {
		JsonObject obj = IceClientTool.sendMsg(IceClientTool.PAY_ICE_SERVICE,
				JSONTool.buildParams("b2BPayService/backMoney", orderId));
	...
	public static boolean backMoneyForAdmin(PayHead payHead) {
		JsonObject obj = IceClientTool.sendMsg(IceClientTool.PAY_ICE_SERVICE,
				JSONTool.buildParams("b2BPayService/backMoneyForAdmin", payHead));
	...
	public static boolean backMoneyForCancel(String orderId, String ip,
			Integer uid) {
		JsonObject obj = IceClientTool.sendMsg(IceClientTool.PAY_ICE_SERVICE,
				JSONTool.buildParams("b2BPayService/backMoneyForCancel", orderId,
						ip, uid));
	...
	public static boolean refundMoneyForAdmin(PayHead payHead, String ip,
			Integer uid) {
		JsonObject obj = IceClientTool.sendMsg(IceClientTool.PAY_ICE_SERVICE,
				JSONTool.buildParams("b2BPayService/refundMoneyForAdmin", payHead,
						ip, uid));
