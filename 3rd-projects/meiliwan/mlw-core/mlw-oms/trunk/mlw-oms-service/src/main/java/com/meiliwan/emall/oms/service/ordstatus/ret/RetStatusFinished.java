 ...
 */
@Component
public class RetStatusFinished extends OrderStatusService{
	...
	public void updateStatus(OrderStatusDTO ordStatusDIO,
		...
		//更新订单行表的状态
		//ordiDao.updateOrdIStatus(ordStatusDIO.getOrderItemId(), RET_FINISHED.getCode());
		updateOrdIAndOrdStatus(ordStatusDIO, RET_FINISHED);
