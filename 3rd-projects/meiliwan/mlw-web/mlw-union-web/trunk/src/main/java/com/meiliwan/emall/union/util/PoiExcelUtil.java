...
public class PoiExcelUtil {
     ...
     * @param titles
     */
    public static HSSFSheet buildTitles(HSSFSheet sheet,String[] titles){
        int i = 0;
        // 创建一行
