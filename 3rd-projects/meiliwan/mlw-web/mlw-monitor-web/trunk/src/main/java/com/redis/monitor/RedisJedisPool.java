...
public class RedisJedisPool {
	...
	public static void main(String[] args) {
		...
		BasicRedisCacheServer server = new RedisCacheServer("10.249.15.202",
				6379, 
				300, 
				50, 
				3000, 
...
//		RedisCacheThreadLocal.set("0101");
//		BasicRedisCacheServer brc = RedisJedisPool.getRedisCacheServer();
//		String ping = brc.ping();
//		
//		//TODO redis列表加载
//		
//		List<RedisServer> list = getAllRedisServer();
//		System.out.println(list);
//		BasicRedisCacheServer basicRedisCacheServer = RedisJedisPool.getRedisCacheServer("0101");
//		System.out.println(basicRedisCacheServer);
